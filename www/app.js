...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function changeText(){
    if(flag){
      ...
      solucion.innerHTML = `<h1>Solución: </h1> <p id = "solucion-text">Crear un algoritmo de machine learning que sea útil 
         en la definición de puntajes de usuarios para la autorización de un crédito bancario.
         ...
         <img src="mas_btn.png" alt="" id="masBtn">`
