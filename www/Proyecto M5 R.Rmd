...
-LTV Ratio: La relación préstamo-valor representa la relación entre el monto del préstamo y el valor de tasación del activo (normalmente una casa). Los LTV más altos pueden indicar un mayor riesgo.
